...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl.frames = Paths.getSparrowAtlas('MarkeyLogoCool');
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['This mod is presented by'], 45);
				// credTextShit.visible = true;
				case 3:
					addMoreText('LeGoldenBoots', 45);
					addMoreText('Markey33 and many more', 45);
				...
				// credTextShit.screenCenter();
				case 13:
					addMoreText('Unfinised');
				// credTextShit.visible = true;
				case 14:
					addMoreText('Business');
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Vs Adam'); // credTextShit.text += '\nFunkin';
